...
class ShowroomTests(unittest.TestCase):
    ...
    def test_homepage_renders(self):
        ...
        self.assertIn(b'js/app.js?v=41', response.data)
    ...
    def test_whatsapp_quote_targets_requested_number(self):
        ...
        try:
            self.assertEqual(response.status_code, 200)
            self.assertIn(b'const WHATSAPP_LOCAL_NUMBER = "8129723373"', response.data)
            self.assertIn(b'const WHATSAPP_NUMBER = `52${WHATSAPP_LOCAL_NUMBER}`', response.data)

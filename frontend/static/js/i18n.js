(() => {
  ...
  const locales = {
    es: {
      ...
      "refrescos.copy": "Refrescos del catálogo Bbldak, con el mismo precio provisional de $0.01.",
      "refrescos.type": "Refresco",
      "refrescos.case": "Empaque",
      ...
      "refrescos.catalogCopy": "Refrescos disponibles, con el mismo precio provisional de $0.01.",
    ...
    en: {
      ...
      "refrescos.copy": "Drinks from the Bbldak catalog, at the same provisional $0.01 price.",
      ...
      "refrescos.catalogCopy": "Drinks available, at the same provisional $0.01 price.",
    ...
    zh: {
      ...
      "refrescos.copy": "来自 Bbldak 目录的饮料，同样使用 $0.01 的临时价格。",
      "refrescos.type": "饮料",
      "refrescos.case": "包装",
      ...
      "refrescos.catalogCopy": "款饮料可选，同样使用 $0.01 的临时价格。",

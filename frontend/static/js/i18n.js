(() => {
  ...
  const locales = {
    es: {
      "meta.title": "BuldakShop — Catálogo asiático",
      ...
      "brands.index": "08 — Marcas",
      "brands.title": "Lo que vendemos.<br><span>Una selección de Asia.</span>",
      "brands.copy": "Conservamos el nombre comercial de cada marca; los nombres y las descripciones de producto cambian entre español, inglés y chino.",
      "brands.kind.noodles": "Sopas y fideos",
      "brands.kind.snacks": "Papas y botanas",
      "brands.kind.drinks": "Bebidas",
    ...
    en: {
      "meta.title": "BuldakShop — Asian catalog",
      ...
      "brands.index": "08 — Brands",
      "brands.title": "What we sell.<br><span>A selection from Asia.</span>",
      "brands.copy": "Every brand keeps its commercial name; product names and descriptions switch between Spanish, English and Chinese.",
      "brands.kind.noodles": "Soups & noodles",
      "brands.kind.snacks": "Chips & snacks",
      "brands.kind.drinks": "Drinks",
    ...
    zh: {
      ...
      "brands.index": "08 — 品牌",
      "brands.title": "在售品牌。<br><span>来自亚洲的精选商品。</span>",
      "brands.copy": "品牌保留原有商标名称；商品名称和描述可在西班牙语、英语与中文之间切换。",
      "brands.kind.noodles": "汤面与面食",
      "brands.kind.snacks": "薯片与零食",
      "brands.kind.drinks": "饮料",

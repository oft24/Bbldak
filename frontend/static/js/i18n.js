(() => {
  ...
  const locales = {
    es: {
      ...
      "legal.dataCopy": "El nombre y correo que ingreses se usan para preparar y dar seguimiento a tu cotización. No envíes contraseñas ni datos bancarios o de tarjeta mediante este sitio. Al continuar a WhatsApp también aplican las condiciones y el aviso de privacidad de ese servicio.",
    ...
    en: {
      ...
      "legal.dataCopy": "The name and email you provide are used to prepare and follow up on your quotation. Do not submit passwords, bank details or card data through this site. When you continue to WhatsApp, that service’s terms and privacy notice also apply.",
    ...
    zh: {
      ...
      "legal.dataCopy": "你提供的姓名和电子邮箱仅用于准备和跟进询价。请勿通过本网站提交密码、银行或银行卡信息。继续使用 WhatsApp 时，也适用该服务的条款与隐私声明。",

(() => {
  ...
  const locales = {
    es: {
      ...
      "legal.independentCopy": "dangoko es un proyecto independiente. No está afiliado, asociado, patrocinado, autorizado ni respaldado por Samyang Foods Co., Ltd. ni por la marca Buldak.",
      ...
      "legal.dataCopy": "Los datos ingresados se usan únicamente para procesar la demostración solicitada. dangoko no garantiza que el contenido esté libre de errores y no asume responsabilidad por decisiones tomadas sin verificar el empaque o la información oficial del fabricante.",
    ...
    en: {
      ...
      "legal.independentCopy": "dangoko is an independent project. It is not affiliated, associated, sponsored, authorized or endorsed by Samyang Foods Co., Ltd. or the Buldak brand.",
      ...
      "legal.dataCopy": "Submitted data is used only to process the requested demonstration. dangoko does not guarantee error-free content and accepts no liability for decisions made without checking the package or the manufacturer’s official information.",
    ...
    zh: {
      ...
      "legal.independentCopy": "dangoko 是独立项目，与 Samyang Foods Co., Ltd. 或 Buldak 品牌无隶属、关联、赞助、授权或背书关系。",
      ...
      "legal.dataCopy": "提交的数据仅用于处理所请求的演示。dangoko 不保证内容完全无误；如未核对包装或制造商官方信息而作出决定，本网站不承担责任。",

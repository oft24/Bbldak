(() => {
  ...
  const locales = {
    es: {
      ...
      "checkout.whatsappGreeting": "Hola, quiero cotizar este pedido de BuldakShop.",
    ...
    en: {
      ...
      "checkout.whatsappGreeting": "Hello, I would like a quote for this BuldakShop order.",
    ...
    zh: {
      ...
      "checkout.whatsappGreeting": "你好，我想咨询这份 BuldakShop 订单的报价。",
